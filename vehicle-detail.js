...
(function () {
  ...
  var VEHICLES = {
    ...
    slingshot_2016_red: {
      ...
      badges: ['3-Wheeler', 'Manual Transmission', 'Classic Red'],
      ...
      reviews: [
        { name: 'Mike R.', rating: 5, text: "The manual transmission makes this so much fun. Perfect for enthusiasts who love to shift gears." },
      ],
    },
